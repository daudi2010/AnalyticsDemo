...
<%
   if (request.getParameter("rcvemail") == null || request.getParameter("rcvemail").equals("")){
     // take to login
...
<title>AnalyticKEDemo - SetPassword</title>
</head>
<body>
                  ...
                  <div class="card-body">
                        <form id ="loginForm">
                            ...
                            <div class="form-group row">
                                 <div class="col-md-6">
                                     <p class="form-control">Set your new Password</p>
                                </div>
                            </div>
	
                            <div class="form-group row">
                                <label for="pass1" class="col-md-4 col-form-label text-md-right">New Password</label>
                                <div class="col-md-6">
                                    <input type="password" id="pass1" class="form-control" name="pass1" required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pass2" class="col-md-4 col-form-label text-md-right">Confirm Password</label>
                                <div class="col-md-6">
                                    <input type="password" id="pass2" class="form-control" name="pass2" required autofocus>
                                </div>
                            </div>

                            <input type="hidden" id="rcvemail" name="rcvemail" value="<% request.getParameter("rcvemail").trim();      %>">
      ...
      $(function() { 
       ...
       $("#registerb").click(function(e){         
        ...
        $.ajax({type: "POST",
                ...
                data: {rcvDemail:$("rcvemail").val(),pass1:$("#pass1").val()},
                success:function(result){
                   
            if(result==="success"){
                $("#errors").html('<div class=\"alert alert-success\" role=\"alert\">'+
               'Success.Password has been reset!</div>');
